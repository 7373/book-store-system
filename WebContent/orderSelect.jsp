...
<div id="wrap">
	...
	<TABLE cellSpacing=0 cellPadding=0 width=676 align=center border=0>
		<TBODY>
			...
			<TR>
				<TD width=763>
					<TABLE width=763 align=right>
						<TBODY>
							<s:form namespace="/bookshop" action="order_send">
								<tr>
									<td>
										<tr>
											用户
											<input type="text" name="admin"> 收件人
											<input type="text" value="可以不填"
												onfocus="javascript:if(this.value=='可以不填')this.value='';"
												name="buyer"> 地址
											<input type="text" value="可以不填"
												onfocus="javascript:if(this.value=='可以不填')this.value='';"
												name="address"> 电话
							...
							<TR>
								<TD class=p9 align=middle><FONT class=p2>您可以输入用户，点击发货来修改发货信息</B>
								</FONT></TD>
							</TR>
						</TBODY>
					</TABLE>
			...
			<TR>
				<TD vAlign=bottom align=middle width=763><A href="admin.jsp"><U><FONT
